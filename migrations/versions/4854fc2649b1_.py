...
Revision ID: 4854fc2649b1
Revises: 
Create Date: 2020-02-19 21:29:00.505630
...
def upgrade():
    ...
    op.drop_table('rolo_rest_roloscript')
...
def downgrade():
    ...
    op.create_table('rolo_rest_roloscript',
    ...
    sa.PrimaryKeyConstraint('id', name='rolo_rest_roloscript_pkey')
    )
